...
class Reply_infoAction extends UserAction{
	...
	public function _initialize() {
		...
		$this->infoTypes=array(
		 'Gcard'=>array('type'=>'Gcard','name'=>'贺卡','keyword'=>'贺
卡','url'=>'/index.php?g=Wap&m=Gcard&a=lists&token='.$this->token),
		'panorama'=>array('type'=>'panorama','name'=>'全景1','keyword'=>'全景1','url'=>'/index.php?g=Wap&m=Product&a=cats&token='.$this->token),
