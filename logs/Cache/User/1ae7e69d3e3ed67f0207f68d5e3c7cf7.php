...
<div class="content right">
          ...
          <div class="cLine">
			<div class="pageNavigator left">
				<a href="<?php echo U('Member_card/privilege',array('token'=>$token));?>" title="查看会员特权" class="btn btn-primary">
					查看员特权
				</a>
			　<a href="<?php echo U('Member_card/coupon_add',array('token'=>$token));?>" title="发布优惠券" class="btn btn-primary">
				   发布优惠券
			  </a>　
				<a class="btn btn-primary" href="<?php echo U('Member_card/integral',array('token'=>$token));?>" title="查看礼品券">
					查看礼品券
				</a>　
			</div>
