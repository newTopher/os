...
<div class="content right">
  ...
  <a href='<?php echo U("Text/add");?>' title='新增文本自定义回复' class='btn btn-primary'>新增文本自定义回复</a>　
  ...
  <!--<a class="btn btn-primary" onclick="location.href='index.php?ac=csv&id=9379';" ><img src="<?php echo RES;?>/images/import.png" class="vm" />批量导入文本</a>　<a class="btn btn-primary" onclick="location.href='index.php?ac=outtxt&page=1&type=0&classid=0&wxid=gh_858dwjkeww5';" ><img src="<?php echo RES;?>/images/export.png" class="vm" />批量导出本页文本结果</a>-->
        ...
        <div class="alert alert-info">
            ...
            <strong>提示信息!</strong>
            <ol>
                <li>在这里您可以添加关键词回复信息,比如您添加"万普微盟"这个关键词以后，用户在微信输入"万普微盟"系统就会回复您所设置的回复内容，以文字的形式回复给用户</li>
              ...
              <TBODY>
				...
				<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td><?php echo ($vo["click"]); ?></td>
                   ...
                   <td class="norightborder"> <a href="<?php echo U('Text/edit',array('id'=>$vo['id']));?>" title="编辑文本">编辑</a>
                       <a onclick="source_delete('<?php echo U('Text/del',array('id'=>$vo['id']));?>')" href="#">删除</a></td>
