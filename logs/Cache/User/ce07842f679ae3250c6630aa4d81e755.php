		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
                <tr>
				  ...
				  <td>
                      http://v.wapwei.com/index.php/Wap/Index/index/token/<?php echo ($_SESSION['token']); ?>
                  </td>
				</tr>
				<tr>
				  <th valign="top"><span class="red">*</span>关键词：</th>
				  <td>
                      <input type="text" name="keywords" value="首页" class="px" style="width:300px;" onfocus="leave();" readonly="readonly">
                  </td>
				</tr>
				<tr>
					<th width="120">回复标题：</th>
					<td><input type="text" id="title" name="title" value="<?php echo ($home["title"]); ?>" class="px" style="width:300px;" onfocus="leave();" ></td>
				</tr>
				<tr>
					<th width="120">内容介绍：</th>
					<td><textarea style="width:300px;height:75px" name="info" id="info" class="px" onfocus="leave();" ><?php echo ($home["info"]); ?></textarea><br/>最多填写120个字</td>
				</tr>
                <TR>
                    <TH valign="top"><label for="picurl">封面图片展示：</label></TH>

                    <TD><img style="display: block;" id="image_show" class="indexs_img" src="<?php echo ($home["picurl"]); ?>"></TD>
                </TR>
				<tr>
					<th>回复图片：</th>
					<td>
                    <input type="hidden" class="text textMiddle inputQ"  name="picurl" id="pic" value="<?php echo ($home["picurl"]); ?>" style="width:300px;"   />
