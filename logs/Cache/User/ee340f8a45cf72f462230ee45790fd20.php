...
<td>
	...
	<input type="input" class="px" id="enddate" value="" name="enddate" onClick="WdatePicker()">
</td>
</tr>
<tr>
<th>券类型：</th>
...
<span id="cktime" style="display:none">可抵用金额：<input type="input" class="px" id="price" value="" name="price" style="width:50px;">元</span>
　
</td>
</tr>
...
<tr>
	...
	<td>
		<textarea name="info" id="info" rows="5" style="width: 410px; height: 250px; display: none;"></textarea>
	</td>
</tr>  
<tr>
<th>数量：</th>
...
<tr>
	<th></th>
	<td><button type="button" id="bsubmit" class="btn btn-primary">保存</button>　</td>
</tr>
...
<script type="text/javascript">
    $(function(){
        $("#bsubmit").click(function(){
            ...
            $.post("<?php echo U('Member_card/coupon_add');?>",
                    {people:people,price:price,info:info,title:title,statdate:statdate,enddate:enddate,group:group,type:type,__hash__:__hash__},
                    function(data){
                        if(data.status == 1){
                            notif({
                                msg: data.info,
